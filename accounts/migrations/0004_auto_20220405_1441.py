# Generated by Django 3.0.14 on 2022-04-05 05:41
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='user',
            name='avatar',
            field=models.ImageField(blank=True, help_text='45px * 45px 크기의 png/jpg 파일을 업로드 하세요.', upload_to='accounts/profile/%Y/%m/%d'),
        ),
    ]
